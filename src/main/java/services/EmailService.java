...
// Temporary fix for PKIX path error
    ...
    public void sendBookingConfirmationWithPdf(String toEmail,
                                               String userName,
                                               String activityName,
                                               double price,
        ...
        <html>
          <body style="margin:0;padding:0;background:#f3f6ff;font-family:Arial,sans-serif;color:#111827;">
            <div style="max-width:640px;margin:0 auto;padding:24px;">
              ...
              <div style="background:#ffffff;border-radius:16px;padding:22px;margin-top:16px;
                          box-shadow:0 10px 24px rgba(17,24,39,0.08);border:1px solid #eef2ff;">
                <h1 style="margin:0 0 10px;font-size:22px;">Booking confirmed ✅</h1>

                <p style="margin:0 0 14px;font-size:14px;line-height:1.6;color:#374151;">
                  Hello <strong>%s</strong>,<br/>
                  Your booking has been successfully confirmed.<br/>
                  <strong>Your ticket PDF is attached to this email.</strong>
                </p>

                <div style="background:#f7fbff;border:1px solid #e5edff;border-radius:14px;padding:14px;">
                  <div style="font-size:14px;margin:0 0 6px;"><strong>Activity:</strong> %s</div>
                  <div style="font-size:14px;margin:0;"><strong>Price:</strong> %s TND</div>
                </div>
        ...
        try {
            ...
            pdfBytes = pdfService.generateReservationPdfBytes(reservation);
        } catch (Exception e) {
            throw new MessagingException("Impossible de générer le PDF", e);
        }
