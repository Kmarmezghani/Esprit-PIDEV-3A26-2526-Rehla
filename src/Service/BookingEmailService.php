  ...
  <body style="margin:0;padding:0;background:#f3f6ff;font-family:Arial,sans-serif;color:#111827;">
    <div style="max-width:640px;margin:0 auto;padding:24px;">
      ...
      <div style="background:#ffffff;border-radius:16px;padding:22px;margin-top:16px;
        ...
        <div style="margin-top:18px;padding:16px;background:#ffffff;border:1px dashed #c7d2fe;border-radius:14px;text-align:center;">
          <p style="margin:0 0 12px;font-size:14px;color:#374151;">
            Your QR ticket
          </p>
          <img src="{$qrDataUri}" alt="QR Code Ticket" style="width:220px;height:220px;display:block;margin:0 auto;">
